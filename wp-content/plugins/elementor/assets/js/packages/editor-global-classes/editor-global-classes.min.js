...
`}),(0,bn.getMCPByDomain)(`canvas`))}0&&(t.exports={ClassManagerPanelEmbedded,GLOBAL_CLASSES_URI:Y,addDocumentClasses,createLabelsForClasses,init,loadExistingClasses,trackGlobalClasses})}))());(window.elementorV2=window.elementorV2||{}).editorGlobalClasses=l})(),window.elementorV2.editorGlobalClasses?.init?.();