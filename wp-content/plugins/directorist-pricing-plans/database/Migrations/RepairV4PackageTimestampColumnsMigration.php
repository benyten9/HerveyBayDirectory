...
class RepairV4PackageTimestampColumnsMigration implements Migration {
    ...
    public function execute(): bool {
        ...
        $wpdb->query( "ALTER TABLE {$packages_table} MODIFY current_period_end TIMESTAMP NULL DEFAULT NULL" );
        $wpdb->query( "ALTER TABLE {$packages_table} MODIFY cancelled_at TIMESTAMP NULL DEFAULT NULL" );
        ...
        $wpdb->query(
            ...
            WHERE cancelled_at = '0000-00-00 00:00:00'"
        );
