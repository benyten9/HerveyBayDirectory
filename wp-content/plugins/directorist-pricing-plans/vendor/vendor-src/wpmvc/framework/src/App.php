...
namespace DirectoristPricingPlan\WpMVC;

\defined('ABSPATH') || exit;
use DirectoristPricingPlan\DI\Container;
use DirectoristPricingPlan\WpMVC\Contracts\Provider;
use DirectoristPricingPlan\WpMVC\Providers\EnqueueServiceProvider;
use DirectoristPricingPlan\WpMVC\Providers\MigrationServiceProvider;
use DirectoristPricingPlan\WpMVC\Providers\RouteServiceProvider;
class App
{
