...
namespace DirectoristPricingPlan\WpMVC\Database\Eloquent;

\defined("ABSPATH") || exit;
use DirectoristPricingPlan\WpMVC\Database\Eloquent\Relations\BelongsToMany;
use DirectoristPricingPlan\WpMVC\Database\Eloquent\Relations\BelongsToOne;
use DirectoristPricingPlan\WpMVC\Database\Eloquent\Relations\HasOne;
