...
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Header\Part\DatePart;
/**
...
class ReceivedHeader extends ParameterHeader
{
    ...
    {
        return isset($this->parameters['from']) ? $this->parameters['from']->getEhloName() : null;
    }
    /**
    ...
    {
        return isset($this->parameters['from']) ? $this->parameters['from']->getHostname() : null;
    }
    /**
    ...
    {
        return isset($this->parameters['from']) ? $this->parameters['from']->getAddress() : null;
    }
    /**
    ...
    {
        return isset($this->parameters['by']) ? $this->parameters['by']->getEhloName() : null;
    }
    /**
    ...
    {
        return isset($this->parameters['by']) ? $this->parameters['by']->getHostname() : null;
    }
    /**
    ...
    {
        return isset($this->parameters['by']) ? $this->parameters['by']->getAddress() : null;
    }
    /**
