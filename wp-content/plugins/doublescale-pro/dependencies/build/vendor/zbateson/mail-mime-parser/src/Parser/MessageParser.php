...
class MessageParser
{
    ...
    public function __construct(PartBuilderFactory $pbf, PartHeaderContainerFactory $phcf, ParserManager $pm, HeaderParser $hp)
    {
    ...
    public function parse(StreamInterface $stream)
    {
        ...
        $this->headerParser->parse($partBuilder->getMessageResourceHandle(), $headerContainer);
