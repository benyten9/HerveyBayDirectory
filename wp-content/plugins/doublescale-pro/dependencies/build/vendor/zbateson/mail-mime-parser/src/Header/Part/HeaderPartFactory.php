...
use DoubleScale\Pro\Vendor\ZBateson\MbWrapper\MbWrapper;
/**
...
class HeaderPartFactory
{
     ...
     */
    public function newReceivedDomainPart($name, $value, $ehloName = null, $hostName = null, $hostAddress = null)
    {
        return new ReceivedDomainPart($this->charsetConverter, $name, $value, $ehloName, $hostName, $hostAddress);
    }
}
