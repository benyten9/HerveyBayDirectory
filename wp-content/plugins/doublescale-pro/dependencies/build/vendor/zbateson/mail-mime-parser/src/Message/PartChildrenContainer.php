...
class PartChildrenContainer implements ArrayAccess, RecursiveIterator
{
    ...
    {
        return $this->current() instanceof IMultiPart && $this->current()->getChildIterator() !== null;
    }
    /**
    ...
    public function add(IMessagePart $part, $position = null)
    {
        ...
        \array_splice($this->children, $index, 0, [$part]);
    }
    /**
    ...
    public function offsetSet($offset, $value) : void
    {
        if (!$value instanceof IMessagePart) {
            throw new InvalidArgumentException(\get_class($value) . ' is not a ZBateson\\MailMimeParser\\Message\\IMessagePart');
        }
