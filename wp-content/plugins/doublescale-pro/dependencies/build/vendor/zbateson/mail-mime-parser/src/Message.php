 ...
 */
namespace DoubleScale\Pro\Vendor\ZBateson\MailMimeParser;

use GuzzleHttp\Psr7;
use Psr\Http\Message\StreamInterface;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Header\HeaderConsts;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\Helper\MultipartHelper;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\Helper\PrivacyHelper;
...
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\PartFilter;
...
class Message extends MimePart implements IMessage
{
    ...
    public function __construct(?PartStreamContainer $streamContainer = null, ?PartHeaderContainer $headerContainer = null, ?PartChildrenContainer $partChildrenContainer = null, ?MultipartHelper $multipartHelper = null, ?PrivacyHelper $privacyHelper = null)
    {
        parent::__construct(null, $streamContainer, $headerContainer, $partChildrenContainer);
        if ($multipartHelper === null || $privacyHelper === null) {
            $di = MailMimeParser::getDependencyContainer();
            $multipartHelper = $di[\DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\Helper\MultipartHelper::class];
            $privacyHelper = $di[\DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\Helper\PrivacyHelper::class];
        }
    ...
    {
        return $this->getPart($index, PartFilter::fromInlineContentType('text/plain'));
    }
    ...
    {
        return $this->getPart($index, PartFilter::fromInlineContentType('text/html'));
    }
    ...
    {
        $this->multipartHelper->setContentPartForMimeType($this, 'text/plain', $resource, $charset);
        return $this;
    }
    public function setHtmlPart($resource, string $charset = 'UTF-8') : self
    {
        $this->multipartHelper->setContentPartForMimeType($this, 'text/html', $resource, $charset);
        return $this;
    }
    public function removeTextPart(int $index = 0) : bool
    {
        return $this->multipartHelper->removePartByMimeType($this, 'text/plain', $index);
    }
    public function removeAllTextParts(bool $moveRelatedPartsBelowMessage = \true) : bool
    {
        return $this->multipartHelper->removeAllContentPartsByMimeType($this, 'text/plain', $moveRelatedPartsBelowMessage);
    }
    public function removeHtmlPart(int $index = 0) : bool
    {
        return $this->multipartHelper->removePartByMimeType($this, 'text/html', $index);
    }
    public function removeAllHtmlParts(bool $moveRelatedPartsBelowMessage = \true) : bool
    {
        return $this->multipartHelper->removeAllContentPartsByMimeType($this, 'text/html', $moveRelatedPartsBelowMessage);
    }
    public function getAttachmentPart(int $index)
    {
        return $this->getPart($index, PartFilter::fromAttachmentFilter());
    }
    public function getAllAttachmentParts()
    {
        return $this->getAllParts(PartFilter::fromAttachmentFilter());
    }
    ...
    {
        $this->multipartHelper->createAndAddPartForAttachment($this, $resource, $mimeType, \strcasecmp($disposition, 'inline') === 0 ? 'inline' : 'attachment', $filename, $encoding);
        return $this;
    }
    /**
     * @return static
    ...
    {
        return $this->privacyHelper->getSignedMessageStream($this);
    }
    public function getSignedMessageAsString()
    {
        return $this->privacyHelper->getSignedMessageAsString($this);
    }
    ...
    {
        $this->privacyHelper->setMessageAsMultipartSigned($this, $micalg, $protocol);
        return $this;
    }
    public function setSignature(string $body) : self
    {
        $this->privacyHelper->setSignature($this, $body);
        return $this;
    }
}
