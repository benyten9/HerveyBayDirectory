...
class PartHeaderContainer implements IteratorAggregate
{
    ...
    private function getByIndex(int $index)
    {
        ...
        if ($this->headerObjects[$index] === null) {
            $this->headerObjects[$index] = $this->headerFactory->newInstance($this->headers[$index][0], $this->headers[$index][1]);
        }
    ...
    private function getByIndexAs(int $index, string $iHeaderClass) : ?IHeader
    {
        ...
        return $this->headerFactory->newInstanceOf($this->headers[$index][0], $this->headers[$index][1], $iHeaderClass);
    }
    /**
