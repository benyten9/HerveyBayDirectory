...
class PartBuilder
{
    ...
    {
        return $this->parent !== null ? $this->parent->getStream() : $this->messageStream;
    }
    /**
    ...
    {
        return $this->parent !== null ? $this->parent->getMessageResourceHandle() : $this->messageHandle;
    }
    /**
    ...
    public function isMime() : bool
    {
        ...
        return $this->headerContainer->exists(HeaderConsts::CONTENT_TYPE) || $this->headerContainer->exists(HeaderConsts::MIME_VERSION);
    }
}
