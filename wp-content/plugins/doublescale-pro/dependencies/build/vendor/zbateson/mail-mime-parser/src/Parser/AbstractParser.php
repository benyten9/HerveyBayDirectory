...
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserPartProxyFactory;
/**
...
abstract class AbstractParser implements IParser
{
    ...
    public function __construct(ParserPartProxyFactory $parserMessageProxyFactory, ParserPartProxyFactory $parserPartProxyFactory, PartBuilderFactory $partBuilderFactory)
    {
