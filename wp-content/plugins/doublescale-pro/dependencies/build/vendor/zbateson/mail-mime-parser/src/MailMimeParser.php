...
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\MessageParser;
/**
...
class MailMimeParser
{
    ...
    public function __construct()
    {
        ...
        $di = static::$di;
        $this->messageParser = $di[\DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\MessageParser::class];
    }
    /**
    ...
    {
        $stream = Utils::streamFor($resource, ['metadata' => ['mmp-detached-stream' => $attached !== \true]]);
