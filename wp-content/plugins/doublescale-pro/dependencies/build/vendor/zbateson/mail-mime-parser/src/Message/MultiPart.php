...
abstract class MultiPart extends MessagePart implements IMultiPart
{
    ...
    public function __construct(?IMimePart $parent = null, ?PartStreamContainer $streamContainer = null, ?PartChildrenContainer $partChildrenContainer = null)
    {
    ...
    {
        return $this->iteratorFindAt($this->getAllPartsIterator(), $index, $fnFilter);
    }
    ...
    {
        return $this->iteratorFindAt($this->partChildrenContainer, $index, $fnFilter);
    }
