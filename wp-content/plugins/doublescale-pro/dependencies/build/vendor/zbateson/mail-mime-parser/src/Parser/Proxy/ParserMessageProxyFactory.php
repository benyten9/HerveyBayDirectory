...
class ParserMessageProxyFactory extends ParserMimePartProxyFactory
{
    ...
    public function __construct(StreamFactory $sdf, PartHeaderContainerFactory $phcf, ParserPartStreamContainerFactory $pscf, ParserPartChildrenContainerFactory $ppccf, MultipartHelper $multipartHelper, PrivacyHelper $privacyHelper)
    {
    ...
    public function newInstance(PartBuilder $partBuilder, IParser $parser)
    {
        ...
        $message = new Message($streamContainer, $headerContainer, $childrenContainer, $this->multipartHelper, $this->privacyHelper);
