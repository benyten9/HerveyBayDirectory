...
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Message\UUEncodedPart;
...
class ParserUUEncodedPartProxyFactory extends ParserPartProxyFactory
{
    ...
    public function newInstance(PartBuilder $partBuilder, IParser $parser)
    {
        ...
        $part = new UUEncodedPart($parserProxy->getUnixFileMode(), $parserProxy->getFileName(), $partBuilder->getParent()->getPart(), $streamContainer);
