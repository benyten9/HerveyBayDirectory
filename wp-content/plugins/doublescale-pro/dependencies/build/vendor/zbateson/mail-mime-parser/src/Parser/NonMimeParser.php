 ...
 */
namespace DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser;

use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Part\UUEncodedPartHeaderContainerFactory;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserMimePartProxy;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserNonMimeMessageProxy;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserNonMimeMessageProxyFactory;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserPartProxy;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserUUEncodedPartProxy;
use DoubleScale\Pro\Vendor\ZBateson\MailMimeParser\Parser\Proxy\ParserUUEncodedPartProxyFactory;
/**
...
class NonMimeParser extends AbstractParser
{
    ...
    public function __construct(ParserNonMimeMessageProxyFactory $parserNonMimeMessageProxyFactory, ParserUUEncodedPartProxyFactory $parserUuEncodedPartProxyFactory, PartBuilderFactory $partBuilderFactory, UUEncodedPartHeaderContainerFactory $uuEncodedPartHeaderContainerFactory)
    {
