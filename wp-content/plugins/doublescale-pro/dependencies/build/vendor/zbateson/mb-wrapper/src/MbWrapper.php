 ...
 */
namespace DoubleScale\Pro\Vendor\ZBateson\MbWrapper;
...
class MbWrapper
{
     ...
     */
    protected $mappedMbCharsets = ['UTF8' => 'UTF-8', 'USASCII' => 'US-ASCII', 'ISO88591' => 'ISO-8859-1'];
    /**
    ...
    public function convert(string $str, string $fromCharset, string $toCharset) : string
    {
        ...
        if ($str !== '') {
            ...
            return \iconv($this->getIconvAlias($fromCharset), $this->getIconvAlias($toCharset) . '//TRANSLIT//IGNORE', $str);
        }
        return $str;
    }
    /**
