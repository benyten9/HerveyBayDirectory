...
use DoubleScale\Pro\Vendor\Symfony\Component\Process\Process;
class Patches implements PluginInterface, EventSubscriberInterface
{
    ...
    public function postInstall(PackageEvent $event)
    {
        ...
        foreach ($this->patches[$package_name] as $description => $url) {
            ...
            try {
                $this->eventDispatcher->dispatch(NULL, new \cweagans\Composer\PatchEvent(\cweagans\Composer\PatchEvents::PRE_PATCH_APPLY, $package, $url, $description));
                $this->getAndApplyPatch($downloader, $install_path, $url, $package);
                $this->eventDispatcher->dispatch(NULL, new \cweagans\Composer\PatchEvent(\cweagans\Composer\PatchEvents::POST_PATCH_APPLY, $package, $url, $description));
