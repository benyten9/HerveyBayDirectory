...
namespace DoubleScale\Pro\Vendor\Stripe\Billing;
 ...
 */
class Meter extends \DoubleScale\Pro\Vendor\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';
    use \DoubleScale\Pro\Vendor\Stripe\ApiOperations\NestedResource;
