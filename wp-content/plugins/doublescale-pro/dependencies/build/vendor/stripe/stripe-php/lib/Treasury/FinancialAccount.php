...
namespace DoubleScale\Pro\Vendor\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \DoubleScale\Pro\Vendor\Stripe\ApiResource
{
    const OBJECT_NAME = 'treasury.financial_account';
    use \DoubleScale\Pro\Vendor\Stripe\ApiOperations\Update;
    ...
    public static function create($params = null, $options = null)
    {
        ...
        $obj = \DoubleScale\Pro\Vendor\Stripe\Util\Util::convertToStripeObject($response->json, $opts);
    ...
    {
        $url = static::classUrl();
        return static::_requestPage($url, \DoubleScale\Pro\Vendor\Stripe\Collection::class, $params, $opts);
    }
    /**
    ...
    {
        $opts = \DoubleScale\Pro\Vendor\Stripe\Util\RequestOptions::parse($opts);
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \DoubleScale\Pro\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
