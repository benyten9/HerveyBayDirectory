...
namespace DoubleScale\Pro\Vendor\Stripe\V2;
 ...
 */
class Collection extends \DoubleScale\Pro\Vendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \DoubleScale\Pro\Vendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \DoubleScale\Pro\Vendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \DoubleScale\Pro\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
