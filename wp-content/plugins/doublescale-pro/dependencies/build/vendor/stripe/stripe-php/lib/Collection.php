...
class Collection extends StripeObject implements \Countable, \IteratorAggregate
{
    ...
    public function all($params = null, $opts = null)
    {
        ...
        if (!$obj instanceof \DoubleScale\Pro\Vendor\Stripe\Collection) {
            throw new \DoubleScale\Pro\Vendor\Stripe\Exception\UnexpectedValueException('Expected type ' . \DoubleScale\Pro\Vendor\Stripe\Collection::class . ', got "' . \get_class($obj) . '" instead.');
        }
