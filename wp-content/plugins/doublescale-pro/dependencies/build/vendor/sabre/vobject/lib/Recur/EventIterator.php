...
use DoubleScale\Pro\Vendor\Sabre\VObject\Component\VEvent;
use DoubleScale\Pro\Vendor\Sabre\VObject\Settings;
/**
...
class EventIterator implements \Iterator
{
    ...
    public function __construct($input, $uid = null, ?DateTimeZone $timeZone = null)
    {
        ...
        if (isset($this->masterEvent->RDATE)) {
            ...
            $this->recurIterator = new RDateIterator($rdateValues, $this->startDate);
