...
namespace DoubleScale\Pro\Vendor\Sabre\VObject\Recur;

use DateTimeImmutable;
use DateTimeInterface;
use Iterator;
use DoubleScale\Pro\Vendor\Sabre\VObject\DateTimeParser;
use DoubleScale\Pro\Vendor\Sabre\VObject\InvalidDataException;
use DoubleScale\Pro\Vendor\Sabre\VObject\Property;
/**
 * RRuleParser.
 *
...
class RRuleIterator implements Iterator
{
    ...
    protected function nextMonthly()
    {
        ...
        $this->currentDate = $this->currentDate->setDate((int) $this->currentDate->format('Y'), (int) $this->currentDate->format('n'), (int) $occurrence)->modify($this->startTime());
    }
    /**
    ...
    protected function nextYearly()
    {
        ...
        if ($this->byDay || $this->byMonthDay) {
            ...
            $this->currentDate = $this->currentDate->setDate((int) $currentYear, (int) $currentMonth, (int) $occurrence)->modify($this->startTime());
            return;
        } else {
            ...
            $this->currentDate = $this->currentDate->setDate((int) $currentYear, (int) $currentMonth, (int) $currentDayOfMonth)->modify($this->startTime());
            return;
        }
    }
    /* }}} */
