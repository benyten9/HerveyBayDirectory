...
namespace DoubleScale\Pro\Vendor\Sabre\VObject\Property\VCard;
...
use DoubleScale\Pro\Vendor\Sabre\Xml;
/**
...
class DateAndOrTime extends Property
{
    ...
    public function setDateTime(DateTimeInterface $dt)
    {
        ...
        if ($isUtc) {
            $value = $dt->format('DoubleScale\\Pro\\Vendor\\Ymd\\THis\\Z');
        } else {
            // Calculating the offset.
            $value = $dt->format('DoubleScale\\Pro\\Vendor\\Ymd\\THisO');
        }
        $this->value = $value;
    }
    /**
