...
namespace DoubleScale\Pro\Vendor\Sabre\CardDAV\Xml\Request;

use DoubleScale\Pro\Vendor\Sabre\CardDAV\Plugin;
...
class AddressBookQueryReport implements XmlDeserializable
{
    ...
    {
        $elems = (array) $reader->parseInnerTree(['{urn:ietf:params:xml:ns:carddav}prop-filter' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CardDAV\\Xml\\Filter\\PropFilter', '{urn:ietf:params:xml:ns:carddav}param-filter' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CardDAV\\Xml\\Filter\\ParamFilter', '{urn:ietf:params:xml:ns:carddav}address-data' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CardDAV\\Xml\\Filter\\AddressData', '{DAV:}prop' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue']);
