...
class PropPatch implements Element
{
    ...
    public static function xmlDeserialize(Reader $reader)
    {
        ...
        $elementMap['{DAV:}prop'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\DAV\\Xml\\Element\\Prop';
        $elementMap['{DAV:}set'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue';
        $elementMap['{DAV:}remove'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue';
