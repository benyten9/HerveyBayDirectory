...
class CalendarMultiGetReport implements XmlDeserializable
{
    ...
    {
        $elems = $reader->parseInnerTree(['{urn:ietf:params:xml:ns:caldav}calendar-data' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Filter\\CalendarData', '{DAV:}prop' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue']);
