...
namespace DoubleScale\Pro\Vendor\Sabre\DAV\Sync;

use DoubleScale\Pro\Vendor\Sabre\DAV;
use DoubleScale\Pro\Vendor\Sabre\DAV\Xml\Request\SyncCollectionReport;
...
class Plugin extends DAV\ServerPlugin
{
    ...
    {
        $this->server = $server;
        $server->xml->elementMap['{DAV:}sync-collection'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\DAV\\Xml\\Request\\SyncCollectionReport';
        $self = $this;
