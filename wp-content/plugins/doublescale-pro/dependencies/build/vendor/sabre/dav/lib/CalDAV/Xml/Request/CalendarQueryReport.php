...
class CalendarQueryReport implements XmlDeserializable
{
    ...
    {
        $elems = $reader->parseInnerTree(['{urn:ietf:params:xml:ns:caldav}comp-filter' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Filter\\CompFilter', '{urn:ietf:params:xml:ns:caldav}prop-filter' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Filter\\PropFilter', '{urn:ietf:params:xml:ns:caldav}param-filter' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Filter\\ParamFilter', '{urn:ietf:params:xml:ns:caldav}calendar-data' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Filter\\CalendarData', '{DAV:}prop' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue']);
