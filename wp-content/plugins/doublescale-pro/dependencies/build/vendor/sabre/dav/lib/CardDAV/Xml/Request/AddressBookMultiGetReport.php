...
class AddressBookMultiGetReport implements XmlDeserializable
{
    ...
    {
        $elems = $reader->parseInnerTree(['{urn:ietf:params:xml:ns:carddav}address-data' => 'DoubleScale\\Pro\\Vendor\\Sabre\\CardDAV\\Xml\\Filter\\AddressData', '{DAV:}prop' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue']);
