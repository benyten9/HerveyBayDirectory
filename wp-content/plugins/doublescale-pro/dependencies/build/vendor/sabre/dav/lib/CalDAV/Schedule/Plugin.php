...
use DateTimeZone;
use DoubleScale\Pro\Vendor\Sabre\CalDAV\ICalendar;
use DoubleScale\Pro\Vendor\Sabre\CalDAV\ICalendarObject;
use DoubleScale\Pro\Vendor\Sabre\CalDAV\Xml\Property\ScheduleCalendarTransp;
...
use DoubleScale\Pro\Vendor\Sabre\DAV\Exception\NotImplemented;
use DoubleScale\Pro\Vendor\Sabre\DAV\INode;
use DoubleScale\Pro\Vendor\Sabre\DAV\PropFind;
use DoubleScale\Pro\Vendor\Sabre\DAV\PropPatch;
use DoubleScale\Pro\Vendor\Sabre\DAV\Server;
use DoubleScale\Pro\Vendor\Sabre\DAV\ServerPlugin;
use DoubleScale\Pro\Vendor\Sabre\DAV\Sharing;
...
use DoubleScale\Pro\Vendor\Sabre\VObject\ITip;
use DoubleScale\Pro\Vendor\Sabre\VObject\ITip\Broker;
use DoubleScale\Pro\Vendor\Sabre\VObject\ITip\Message;
...
class Plugin extends ServerPlugin
{
    ...
    public function scheduleLocalDelivery(ITip\Message $iTipMessage)
    {
        ...
        // the users' calendars.
        $uid = $iTipMessage->uid;
        $newFileName = 'sabredav-' . \DoubleScale\Pro\Vendor\Sabre\DAV\UUIDUtil::getUUID() . '.ics';
