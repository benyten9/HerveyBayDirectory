...
namespace DoubleScale\Pro\Vendor\Sabre\DAV\Sharing;
...
use DoubleScale\Pro\Vendor\Sabre\DAV\Xml\Property;
...
class Plugin extends ServerPlugin
{
    ...
    {
        $this->server = $server;
        $server->xml->elementMap['{DAV:}share-resource'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\DAV\\Xml\\Request\\ShareResource';
    ...
    public function htmlActionsPanel(INode $node, &$output, $path)
    {
        ...
        if ($aclPlugin) {
            if (!$aclPlugin->checkPrivileges($path, '{DAV:}share', \DoubleScale\Pro\Vendor\Sabre\DAVACL\Plugin::R_PARENT, \false)) {
