...
namespace DoubleScale\Pro\Vendor\Sabre\CardDAV\Backend;

use DoubleScale\Pro\Vendor\Sabre\CardDAV;
...
class PDO extends AbstractBackend implements SyncSupport
{
    ...
    public function createCard($addressBookId, $cardUri, $cardData)
    {
        ...
        $etag = \md5($cardData);
        $stmt->execute([$cardData, $cardUri, \time(), $addressBookId, \strlen($cardData), $etag]);
    ...
    public function updateCard($addressBookId, $cardUri, $cardData)
    {
        ...
        $etag = \md5($cardData);
        $stmt->execute([$cardData, \time(), \strlen($cardData), $etag, $cardUri, $addressBookId]);
