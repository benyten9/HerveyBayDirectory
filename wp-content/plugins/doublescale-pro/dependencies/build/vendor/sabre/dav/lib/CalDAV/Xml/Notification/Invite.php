...
namespace DoubleScale\Pro\Vendor\Sabre\CalDAV\Xml\Notification;

use DoubleScale\Pro\Vendor\Sabre\CalDAV;
use DoubleScale\Pro\Vendor\Sabre\CalDAV\SharingPlugin as SharingPlugin;
...
class Invite implements NotificationInterface
{
    ...
    public function xmlSerializeFull(Writer $writer)
    {
        ...
        $writer->writeElement($cs . 'dtstamp', $this->dtStamp->format('DoubleScale\\Pro\\Vendor\\Ymd\\THis\\Z'));
