...
class ShareResource implements XmlDeserializable
{
    ...
    {
        $elems = $reader->parseInnerTree(['{DAV:}sharee' => 'DoubleScale\\Pro\\Vendor\\Sabre\\DAV\\Xml\\Element\\Sharee', '{DAV:}share-access' => 'DoubleScale\\Pro\\Vendor\\Sabre\\DAV\\Xml\\Property\\ShareAccess', '{DAV:}prop' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Deserializer\\keyValue']);
        $sharees = [];
