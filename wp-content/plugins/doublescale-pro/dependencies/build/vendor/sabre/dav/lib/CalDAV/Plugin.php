...
namespace DoubleScale\Pro\Vendor\Sabre\CalDAV;

use DateTimeZone;
use DoubleScale\Pro\Vendor\Sabre\CalDAV\Xml\Request\CalendarMultiGetReport;
...
use DoubleScale\Pro\Vendor\Sabre\DAV\Xml\Property\LocalHref;
use DoubleScale\Pro\Vendor\Sabre\DAVACL;
use DoubleScale\Pro\Vendor\Sabre\HTTP;
...
class Plugin extends DAV\ServerPlugin
{
    ...
    public function getCalendarHomeForPrincipal($principalUrl)
    {
        ...
        // should).
        $parts = \explode('/', \trim($principalUrl, '/'));
        if (2 !== \count($parts)) {
            return;
        }
    ...
    public function initialize(DAV\Server $server)
    {
        ...
        $server->xml->elementMap['{' . self::NS_CALDAV . '}supported-calendar-component-set'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Property\\SupportedCalendarComponentSet';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}calendar-query'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Request\\CalendarQueryReport';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}calendar-multiget'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Request\\CalendarMultiGetReport';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}free-busy-query'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Request\\FreeBusyQueryReport';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}mkcalendar'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Request\\MkCalendar';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}schedule-calendar-transp'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Property\\ScheduleCalendarTransp';
        $server->xml->elementMap['{' . self::NS_CALDAV . '}supported-calendar-component-set'] = 'DoubleScale\\Pro\\Vendor\\Sabre\\CalDAV\\Xml\\Property\\SupportedCalendarComponentSet';
    ...
    public function httpMkCalendar(RequestInterface $request, ResponseInterface $response)
    {
        ...
        if ($body) {
            ...
            } catch (\DoubleScale\Pro\Vendor\Sabre\Xml\ParseException $e) {
