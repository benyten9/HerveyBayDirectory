...
namespace DoubleScale\Pro\Vendor\Sabre\DAVACL\Xml\Property;

use DoubleScale\Pro\Vendor\Sabre\DAV;
use DoubleScale\Pro\Vendor\Sabre\DAV\Browser\HtmlOutput;
use DoubleScale\Pro\Vendor\Sabre\DAV\Browser\HtmlOutputHelper;
...
class Acl implements Element, HtmlOutput
{
    ...
    {
        $elementMap = ['{DAV:}ace' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\KeyValue', '{DAV:}privilege' => 'DoubleScale\\Pro\\Vendor\\Sabre\\Xml\\Element\\Elements', '{DAV:}principal' => 'DoubleScale\\Pro\\Vendor\\Sabre\\DAVACL\\Xml\\Property\\Principal'];
        $privileges = [];
