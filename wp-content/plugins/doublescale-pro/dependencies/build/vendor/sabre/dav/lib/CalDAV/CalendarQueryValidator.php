...
class CalendarQueryValidator
{
    ...
    protected function validateTextMatch($check, array $textMatch)
    {
        ...
        $isMatching = \DoubleScale\Pro\Vendor\Sabre\DAV\StringUtil::textMatch($check, $textMatch['value'], $textMatch['collation']);
    ...
    protected function validateTimeRange(VObject\Node $component, $start, $end)
    {
        ...
        switch ($component->name) {
            ...
            // no break
            case 'VFREEBUSY':
                throw new \DoubleScale\Pro\Vendor\Sabre\DAV\Exception\NotImplemented('time-range filters are currently not supported on ' . $component->name . ' components');
            case 'COMPLETED':
            case 'CREATED':
            case 'DTEND':
            case 'DTSTAMP':
            ...
            default:
                throw new \DoubleScale\Pro\Vendor\Sabre\DAV\Exception\BadRequest('You cannot create a time-range filter on a ' . $component->name . ' component');
        }
    }
}
