...
namespace DoubleScale\Pro\Vendor\Sabre\Xml;
...
class Service
{
    ...
    public function mapValueObject(string $elementName, string $className)
    {
        ...
        $this->elementMap[$elementName] = function (Reader $reader) use($className, $namespace) {
            return \DoubleScale\Pro\Vendor\Sabre\Xml\Deserializer\valueObject($reader, $className, $namespace);
        };
        $this->classMap[$className] = function (Writer $writer, $valueObject) use($namespace) {
            return \DoubleScale\Pro\Vendor\Sabre\Xml\Serializer\valueObject($writer, $valueObject, $namespace);
        };
