...
namespace DoubleScale\Pro\Vendor\Sabre\Xml\Element;
...
class Uri implements Xml\Element
{
    ...
    {
        $writer->text(\DoubleScale\Pro\Vendor\Sabre\Uri\resolve($writer->contextUri, $this->value));
    }
    /**
    ...
    {
        return new self(\DoubleScale\Pro\Vendor\Sabre\Uri\resolve((string) $reader->contextUri, $reader->readText()));
    }
}
