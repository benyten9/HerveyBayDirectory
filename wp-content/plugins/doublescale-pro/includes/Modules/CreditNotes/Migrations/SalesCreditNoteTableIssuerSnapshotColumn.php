<?php
/**
 * Add issuer snapshot column to credit notes.
 *
...
/**
 * SalesCreditNoteTableIssuerSnapshotColumn migration.
 */
class SalesCreditNoteTableIssuerSnapshotColumn {
	...
	public function run() {
		...
		$table = $wpdb->prefix . 'doublescale_sales_credit_notes';
