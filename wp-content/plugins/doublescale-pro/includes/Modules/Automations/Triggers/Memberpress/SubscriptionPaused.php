...
/**
 * MemberPress Trigger for Subscription Paused
 *
 * @since 1.0.0
 *
...
/**
 * Subscription Paused Trigger
 */
class SubscriptionPaused extends Trigger
{
	...
	{
		add_action('mepr_subscription_status_suspended', array($this, 'subscription_paused'));
	}
	 ...
	 */
	public function subscription_paused($sub)
	{
