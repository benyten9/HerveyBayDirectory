...
/**
 * MemberPress Trigger for Transaction Failed
 *
 * @since 1.0.0
 *
...
/**
 * Transaction Failed Trigger
 */
class TransactionFailed extends Trigger
{
	...
	{
		add_action('mepr-txn-status-failed', array($this, 'transaction_failed'));
	}
