...
/**
 * PMPro Trigger for Membership Expiring Soon
 *
 * Fires before a membership expires, allowing proactive notifications.
 *
 * @since 1.0.0
 *
...
namespace DoubleScale\Pro\Modules\Automations\Triggers\Pmpro;
...
/**
 * Membership Expiring Soon Trigger
 */
class MembershipExpiringSoon extends Trigger
{
	...
	{
		add_action('pmpro_membership_pre_membership_expiry', array($this, 'membership_expiring_soon'), 10, 2);
	}
	 ...
	 * @param int $membership_id Membership level ID about to expire.
	 */
	public function membership_expiring_soon($user_id, $membership_id)
	{
