...
namespace DoubleScale\Pro\Modules\Automations\Actions\Crm\Keap;
	...
	public function process_action( AutomationModel $automation, AutomationStepModel $step, AutomationContactModel $automation_contact ) {
		...
		if ( empty( $email ) ) {
			doublescale_get_logger()->error(
				__( 'Keap Add Contact: Email is required.', 'doublescale'),
				array(
		...
		if ( ! $api ) {
			doublescale_get_logger()->error(
				__( 'Keap Add Contact: Api connection failed.', 'doublescale'),
				array(
					'code' => 'keap_connect',
					'data' => array(
						'automation' => array(
		...
		if ( ! $result['success'] ) {
			doublescale_get_logger()->error(
				__( 'Keap Add Contact: Failed to create or update contact.', 'doublescale'),
				array(
		...
		doublescale_get_logger()->info(
			__( 'Keap Add Contact: Contact added successfully.', 'doublescale'),
			array(
				'code'     => 'keap_add_contact',
				'response' => $result,
			)
