<?php
/**
 * Automation rule: support ticket reply content.
 *
...
class TicketReplyContent extends BaseSupportRule {
	...
	public function get_value( $automation_contact ) {
		return $this->get_trigger_activity_plain_text( $automation_contact, ActivityTypes::SUPPORT_REPLY );
	}
}

BaseSupportRule::register( new TicketReplyContent() );
