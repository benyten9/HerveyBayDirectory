 ...
 *
 * This class is responsible for handling the Deal Probability rule
 *
 * @since 1.0.0
 *
...
/**
 * Deal Probability class
 */
class DealProbability extends Rule
{
...
DealRuleRegistration::register(new DealProbability());
