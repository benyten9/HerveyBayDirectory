...
/**
 * Deal Source Merge Tag
 */
class DealSource extends AbstractDealMergeTag {
	 ...
	 * @var string
	 */
	public $description = 'Deal Source';
...
MergeTagsManager::instance()->register( new DealSource() );
