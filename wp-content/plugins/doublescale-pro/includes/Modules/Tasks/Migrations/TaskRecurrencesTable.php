...
class TaskRecurrencesTable extends Migration {
	...
	public function get_query() {
		return "id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
			...
			month_mode VARCHAR(10) DEFAULT NULL,
			`year_month` TINYINT UNSIGNED DEFAULT NULL,
			repeat_when_completed TINYINT(1) NOT NULL DEFAULT 0,
			status_id BIGINT(20) UNSIGNED NULL DEFAULT NULL,
			create_new_on_repeat TINYINT(1) NOT NULL DEFAULT 1,
