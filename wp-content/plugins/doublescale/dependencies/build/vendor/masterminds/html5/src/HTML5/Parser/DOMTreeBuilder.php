...
namespace DoubleScale\Vendor\Masterminds\HTML5\Parser;

use DoubleScale\Vendor\Masterminds\HTML5\Elements;
use DoubleScale\Vendor\Masterminds\HTML5\InstructionProcessor;
/**
