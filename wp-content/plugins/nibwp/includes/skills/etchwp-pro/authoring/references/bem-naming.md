...
|---|---|---|
| Site-wide default | `etched-` | `.etched-delete-split__label` |
...
Brand-scoped variants carry their brand in `__libraryMeta.brand`; the BEM prefix is what keeps them apart.
...
4. Set `__libraryMeta.brand` to the brand and prefix every class with it.
