...
## Tokens
- [ ] Background: `--bg-dark` or `--bg-ultra-dark` (#0f1117) on dark footers; raw decorative gradient inside brand-scoped files only.
- [ ] Text color: `--text-light-muted` (rgba(255,255,255,0.65)) for body; `--text-light` for strong text.
