...
**Brand / category**: `Alpha` / `CTA`, slug `cta-banner`
...
- Heading on the `--h2` token, stepping down to `--h3` at a container breakpoint — never a fluid `clamp()` size.
...
```json
{
    ...
    "styles": {
        ...
        "alpha-cta-banner__container-style": { "type": "class", "selector": ".alpha-cta-banner__container", "collection": "default", "css": "display: flex; flex-direction: column; align-items: center; text-align: center; gap: var(--space-l, 1.5rem); padding-inline: var(--gutter, 1rem);", "readonly": false },
        "alpha-cta-banner__heading-style": { "type": "class", "selector": ".alpha-cta-banner__heading", "collection": "default", "css": "font-size: var(--h2, 2.25rem); font-weight: 800; margin: 0; color: var(--white, #fff); @container (inline-size < to-rem(600px)) { font-size: var(--h3, 1.5rem); }", "readonly": false },
...
**Brand / category**: `Alpha` / `Features`, slug `feature-grid`
...
- `--neutral-ultra-light` with fallback for the card background — a true grey, where `--base-*` would be tinted by the brand colour.
...
```json
{
    ...
    "styles": {
        ...
        "alpha-features__container-style": { "type": "class", "selector": ".alpha-features__container", "collection": "default", "css": "display: flex; flex-direction: column; gap: var(--space-xl, 3rem); align-items: center; padding-inline: var(--gutter, 1rem);", "readonly": false },
        "alpha-features__title-style": { "type": "class", "selector": ".alpha-features__title", "collection": "default", "css": "font-size: var(--h2, 2.25rem); font-weight: 700; text-align: center; margin: 0; color: var(--text-dark, #111); @container (inline-size < to-rem(600px)) { font-size: var(--h3, 1.5rem); }", "readonly": false },
        ...
        "alpha-features__card-style": { "type": "class", "selector": ".alpha-features__card", "collection": "default", "css": "display: flex; flex-direction: column; gap: var(--space-s, 0.75rem); padding: var(--space-l, 2rem); border-radius: var(--radius-m, 0.75rem); background: var(--neutral-ultra-light, #f2f2f2); text-align: center; align-items: center; transition: box-shadow 0.2s; &:hover { box-shadow: 0 8px 30px rgba(0,0,0,0.08); }", "readonly": false },
        ...
        "alpha-features__card-title-style": { "type": "class", "selector": ".alpha-features__card-title", "collection": "default", "css": "font-size: var(--text-l, 1.125rem); font-weight: 600; margin: 0; color: var(--text-dark, #111);", "readonly": false },
        "alpha-features__card-desc-style": { "type": "class", "selector": ".alpha-features__card-desc", "collection": "default", "css": "font-size: var(--text-m, 1rem); line-height: 1.6; color: var(--text-dark-muted, #4b5563); margin: 0;", "readonly": false }
    }
}
```
...
**Brand / category**: `Luxe Horizon` / `Hero`, slug `hero-fullscreen`
...
```json
{
    ...
    "styles": {
        ...
        "luxe-hero__container-style": { "type": "class", "selector": ".luxe-hero__container", "collection": "default", "css": "display: flex; flex-direction: column; align-items: center; text-align: center; gap: var(--space-l, 1.5rem); padding-inline: var(--gutter, 1rem);", "readonly": false },
        ...
        "luxe-hero__heading-style": { "type": "class", "selector": ".luxe-hero__heading", "collection": "default", "css": "font-family: 'Playfair Display', Georgia, serif; font-size: var(--h1, 3.5rem); font-weight: 400; line-height: 1.15; margin: 0; white-space: pre-line; @container (inline-size < to-rem(600px)) { font-size: var(--h2, 2.25rem); }", "readonly": false },
...
- `__libraryMeta.brand` is `Luxe Horizon`.
...
## 4. Two-column → one-column + heading step-down + opaque style IDs — Alpha Hero Split

**Type / category**: `Elements` / `Hero`, slug `marks-component`

**Why canonical**: the best example of the "two columns on desktop, collapse to one on mobile" pattern, with a heading token that steps down at the breakpoint, and demonstrates that opaque style-object IDs (`7g69qvg`, `nl79no2`) are accepted as long as the selector inside is proper BEM.
...
- Heading steps down one token at the breakpoint: `var(--h1, 3.5rem)` → `var(--h2, 2.25rem)`.
...
```json
{
    ...
    "styles": {
        "7g69qvg": { "type": "class", "selector": ".alpha-hero-split", "collection": "default", "css": "padding-block: var(--section-space-l, 6rem); background: var(--bg-dark, #0f1117); color: var(--white, #fff);", "readonly": false },
        "nl79no2": { "type": "class", "selector": ".alpha-hero-split__container", "collection": "default", "css": "display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-xl, 3rem); align-items: center; padding-inline: var(--gutter, 1rem); @media (max-width: 768px) { grid-template-columns: 1fr; }", "readonly": false },
        ...
        "eipkvha": { "type": "class", "selector": ".alpha-hero-split__heading", "collection": "default", "css": "font-size: var(--h1, 3.5rem); font-weight: 800; line-height: 1.1; margin: 0; color: var(--white, #fff); @media (max-width: 768px) { font-size: var(--h2, 2.25rem); }", "readonly": false },
...
When your task doesn't cleanly match one of these, pick the closest, then adapt. Do not write a payload from scratch — start from the nearest example here and edit it down.
