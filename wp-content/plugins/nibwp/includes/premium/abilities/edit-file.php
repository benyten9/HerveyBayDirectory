...
wp_register_ability('nibwp/edit-file', [
    'label' => __('Edit File', domain: 'nibwp'),
    'description' => __(
    ...
    'execute_callback' => 'nibwp_edit_file',
 ...
 */
function nibwp_edit_replace_first(string $content, string $old_string, string $new_string): string
{
 ...
 */
function nibwp_edit_file($input)
{
    ...
    $new_content = $replace_all
        ...
        : nibwp_edit_replace_first($content, $old_string, $new_string);
