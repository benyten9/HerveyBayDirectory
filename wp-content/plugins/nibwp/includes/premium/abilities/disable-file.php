...
wp_register_ability('nibwp/disable-file', [
    ...
    'input_schema' => [
        ...
        'properties' => [
            'path' => [
                'type' => 'string',
                'description' => 'Path to the sandbox file to disable. Relative paths are resolved from ABSPATH. Must be inside wp-content/nibwp-sandbox/.',
                'minLength' => 1,
            ],
        ],
        'required' => ['path'],
    ...
    'execute_callback' => 'nibwp_disable_file',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                'SANDBOX NOTES:',
                '- Only files inside wp-content/nibwp-sandbox/ (the PHP sandbox) can be disabled.',
 ...
 */
function nibwp_disable_file($input)
{
    $resolved = nibwp_resolve_path((string) $input['path'], must_exist: true);
