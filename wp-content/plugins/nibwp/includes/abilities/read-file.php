 ...
 */
function nibwp_read_file($input)
{
    $resolved = nibwp_resolve_path(path: (string) $input['path'], must_exist: true);
    ...
    $is_text = nibwp_is_text_mime_type($mime_type) && mb_check_encoding(value: $content, encoding: 'UTF-8');
 ...
 * @return bool
 */
function nibwp_is_text_mime_type($mime_type)
{
