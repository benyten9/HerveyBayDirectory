...
namespace DirectoristStripe\WpMVC\Database\Query;
...
use DirectoristStripe\WpMVC\Database\Eloquent\Relationship;
use DirectoristStripe\WpMVC\Database\Query\Compilers\Compiler;
use DirectoristStripe\WpMVC\Database\Eloquent\Relations\Relation;
use DirectoristStripe\WpMVC\Database\Clauses\WhereClause;
use DirectoristStripe\WpMVC\Database\Clauses\HavingClause;
use wpdb;
use stdClass;
