...
namespace DirectoristStripe\WpMVC\Routing;

\defined('ABSPATH') || exit;
use DirectoristStripe\WpMVC\Routing\Providers\RouteServiceProvider;
use DirectoristStripe\WpMVC\Routing\Contracts\Middleware as MiddlewareContract;
use WP_Error;
class Middleware
{
