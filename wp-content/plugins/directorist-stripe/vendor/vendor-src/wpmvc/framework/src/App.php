...
namespace DirectoristStripe\WpMVC;

\defined('ABSPATH') || exit;
use DirectoristStripe\DI\Container;
use DirectoristStripe\WpMVC\Contracts\Provider;
use DirectoristStripe\WpMVC\Providers\EnqueueServiceProvider;
use DirectoristStripe\WpMVC\Providers\MigrationServiceProvider;
use DirectoristStripe\WpMVC\Providers\RouteServiceProvider;
class App
{
