...
namespace DirectoristStripe\DI\Compiler;

use function chmod;
use DirectoristStripe\DI\Definition\ArrayDefinition;
use DirectoristStripe\DI\Definition\DecoratorDefinition;
...
use DirectoristStripe\DI\Definition\Source\DefinitionSource;
use DirectoristStripe\DI\Definition\StringDefinition;
use DirectoristStripe\DI\Definition\ValueDefinition;
use DirectoristStripe\DI\DependencyException;
use DirectoristStripe\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use DirectoristStripe\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
