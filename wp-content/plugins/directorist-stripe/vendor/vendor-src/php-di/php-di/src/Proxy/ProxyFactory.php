...
namespace DirectoristStripe\DI\Proxy;

use DirectoristStripe\ProxyManager\Configuration;
use DirectoristStripe\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use DirectoristStripe\ProxyManager\FileLocator\FileLocator;
use DirectoristStripe\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use DirectoristStripe\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use DirectoristStripe\ProxyManager\Proxy\LazyLoadingInterface;
/**
