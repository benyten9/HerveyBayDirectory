...
namespace DirectoristStripe\Stripe\Privacy;
 ...
 */
class RedactionJob extends \DirectoristStripe\Stripe\ApiResource
{
    const OBJECT_NAME = 'privacy.redaction_job';
    use \DirectoristStripe\Stripe\ApiOperations\NestedResource;
