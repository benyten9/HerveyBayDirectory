...
namespace DirectoristStripe\Stripe\V2;
 ...
 */
class Collection extends \DirectoristStripe\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \DirectoristStripe\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \DirectoristStripe\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function offsetGet($k)
    {
        ...
        throw new \DirectoristStripe\Stripe\Exception\InvalidArgumentException($msg);
    }
    /**
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \DirectoristStripe\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
