 ...
 */
class V2CoreAccountIncludingConfigurationStorerCapabilityStatusUpdatedEvent extends \DirectoristStripe\Stripe\V2\Event
{
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \DirectoristStripe\Stripe\EventData\V2CoreAccountIncludingConfigurationStorerCapabilityStatusUpdatedEventData::constructFrom($evt->data, $opts, $apiMode);
        }
        return $evt;
    }
}
