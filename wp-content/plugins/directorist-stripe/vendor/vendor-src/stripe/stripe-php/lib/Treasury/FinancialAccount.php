...
namespace DirectoristStripe\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \DirectoristStripe\Stripe\ApiResource
{
    const OBJECT_NAME = 'treasury.financial_account';
    use \DirectoristStripe\Stripe\ApiOperations\Update;
    ...
    {
        $url = static::classUrl();
        return static::_requestPage($url, \DirectoristStripe\Stripe\Collection::class, $params, $opts);
    }
    /**
    ...
    {
        $opts = \DirectoristStripe\Stripe\Util\RequestOptions::parse($opts);
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \DirectoristStripe\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
