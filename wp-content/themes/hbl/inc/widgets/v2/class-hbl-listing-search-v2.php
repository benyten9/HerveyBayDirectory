...
class HBL_Listing_Search_V2 extends Widget_Base {

	public function get_name() {
		return 'hbl-listing-search-v2';
	}

	public function get_title() {
		return esc_html__( 'HBL Listing Search V2', 'hbl' );
	}
	...
	public function get_keywords() {
		return array( 'search', 'form', 'listings', 'directory', 'filter', 'v2' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array( 'show_keyword' => 'yes' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#008080',
				'selectors' => array(
					'{{WRAPPER}} .hbl-v2-lsearch-btn' => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#006666',
				'selectors' => array(
					'{{WRAPPER}} .hbl-v2-lsearch-btn:hover' => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array(
					'{{WRAPPER}} .hbl-v2-lsearch-btn' => 'color: {{VALUE}};',
				),
			)
		);
	...
	protected function render() {
		...
		$action_url = ! empty( $settings['search_results_page'] )
			? home_url( $settings['search_results_page'] )
		...
		?>
		<div class="hbl-v2-lsearch-widget">
			<form class="hbl-v2-lsearch-form hbl-v2-lsearch-<?php echo esc_attr( $layout ); ?>"
			      action="<?php echo esc_url( $action_url ); ?>"
			      method="get">

				<div class="hbl-v2-lsearch-fields">

					<?php if ( 'yes' === $settings['show_keyword'] ) : ?>
						<div class="hbl-v2-lsearch-field hbl-v2-lsearch-field-keyword">
							<div class="hbl-v2-lsearch-input-wrapper">
								<svg class="hbl-v2-lsearch-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<circle cx="11" cy="11" r="8" stroke="currentColor" stroke-width="2"/>
									<path d="M21 21L16.65 16.65" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
								</svg>
								<input type="text"
								       name="q"
								       class="hbl-v2-lsearch-input"
					...
					<?php if ( 'yes' === $settings['show_category'] ) : ?>
						<div class="hbl-v2-lsearch-field hbl-v2-lsearch-field-category">
							<div class="hbl-v2-lsearch-select-wrapper">
								<svg class="hbl-v2-lsearch-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M22 19C22 19.5304 21.7893 20.0391 21.4142 20.4142C21.0391 20.7893 20.5304 21 20 21H4C3.46957 21 2.96086 20.7893 2.58579 20.4142C2.21071 20.0391 2 19.5304 2 19V5C2 4.46957 2.21071 3.96086 2.58579 3.58579C2.96086 3.21071 3.46957 3 4 3H9L11 6H20C20.5304 6 21.0391 6.21071 21.4142 6.58579C21.7893 6.96086 22 7.46957 22 8V19Z" stroke="currentColor" stroke-width="2"/>
								</svg>
								<select name="category" class="hbl-v2-lsearch-select">
					...
					<?php if ( 'yes' === $settings['show_location'] ) : ?>
						<div class="hbl-v2-lsearch-field hbl-v2-lsearch-field-location">
							<div class="hbl-v2-lsearch-select-wrapper">
								<svg class="hbl-v2-lsearch-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<select name="location" class="hbl-v2-lsearch-select">
